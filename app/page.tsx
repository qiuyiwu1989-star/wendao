...
export const metadata: Metadata = {
  title: "问道 · 会说话的思维教练",
  description:
    "不给答案，带你把问题想清楚。问道是深脑（DeepBrain）的对话思考层——你张嘴说，它开口问，一来一回把想不通的事想到根上。",
};

const BASE = process.env.NEXT_PUBLIC_BASE_PATH || "";
const REPO = "https://github.com/qiuyiwu1989-star/wendao";
const SHENNAO = "https://shennao.zaowuyun.com";
  ...
  return (
    <main className="doc">
      <nav className="doc-nav">
        ...
        <a className="doc-navbrand" href={SHENNAO} style={{ textDecoration: "none" }}>
          进入深脑 →
        </a>
      </nav>
      ...
      <header className="doc-hero">
        ...
        <div className="intro-cta-row">
          <a className="doc-cta-btn" href={SHENNAO}>
            <Brain size={18} strokeWidth={1.8} />
            在深脑里用完整版
          </a>
          <a className="intro-ghost" href={`${BASE}/chat`}>
            <MessageCircle size={16} strokeWidth={1.8} />
            先试聊两句
          </a>
        </div>
        <p className="intro-note">
          试用版是纯教练。<strong>登录深脑后</strong>，它才读得到你自己的判断与积累，问出"懂你"的问题。
        </p>
      </header>
      ...
      <section className="doc-section">
        ...
        <p className="doc-p doc-north">
          <strong>所以问道住在深脑里。</strong>
          它要读的是<em>你自己</em>的判断与积累——这件事只有在深脑里、认证过之后才成立。
          外面这个试用版读不到任何人的大脑，也不会写入任何东西。
        </p>
      </section>
